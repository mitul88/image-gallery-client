...
const SingleInputForm = ({defaultValue, onClose, elemType}) => {
  return (
    <form>
        <div className="flex">
            {!elemType && (
                <input type="text" defaultValue={defaultValue} className="border border-gray-200 px-2 rounded" />
            )}
            {elemType === 'textarea' && (
                <textarea type="text" defaultValue={defaultValue} className="border border-gray-200 px-2 rounded" />
            )}
